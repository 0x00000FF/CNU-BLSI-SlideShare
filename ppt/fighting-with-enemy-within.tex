...
\begin{document}
    ...
    \begin{frame}{CpG Hypermethylation}
        ...
        \end{center}
        Densed methylation for CpG island disables specific gene expression.
    \end{frame}
    ...
    \begin{frame}{References}
        \footnotesize Carey, N. (2012). \textit{The Epigenetics Revolution}. Columbia University Press
    
        \footnotesize Kakumani, R., et al. (2012). \textit{Identification of CpG islands in DNA sequences using statistically optimal null filters}, EURASIP Journal on Bioinformatics and Systems Biology 
    \end{frame}
